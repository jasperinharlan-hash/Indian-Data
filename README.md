...
This repository is for publicly sharing Indian-related datasets that I collected and organized.
...
- Please cite this repository URL and the specific file name when reusing data.
- 每个数据文件需包含清晰的字段说明。
